...
import { PinataFileManager } from '../constant/ipfs';
import toast from 'react-hot-toast';



export interface AssetsCreationMetadata {
    title: string;
    description: string;
    location: string;
    category: string;
    value: string;
    tokens: number; // Change from Number to number
    currency: 'USDT' | 'ETH';
    propertyType: 'Residential' | 'Land' | 'Commercial' | 'Industrial';
    images: File[];
    documents: File[];
    validatorId: string;
    areaSqft: string;
